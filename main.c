...
struct seq_item {
    void *fifo_reserved;  // Zephyr FIFO header, täytyy olla ensimmäisenä
    char color;
};

// (Voit siivota pois led_state -logiikan kun kaikki on sekvensseistä, mutta jätin sen toistaiseksi)
...
// Button 1 - Pause (pidin tämän erillisenä, ellei halua puskuroida 'P' sekvenssina)
